...
public class ReportResponse extends BaseResponse {
    ...
    public ReportResponse(Response data) throws IOException, JSONException {
        super(data);
    }
...
//        managementUnitEntities.add(managementUnitEntity);
         Type type= new TypeToken<ArrayList<ReportResponse>>(){}.getType();
         reportEntities = gson.fromJson(data.body().string(),type);
    }
